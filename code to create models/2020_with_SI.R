...
#
#Add SI data to this frame
SI <- read_csv("COVID-Counterfactual/all_OSI.csv") %>% dplyr::select(location, date, stringency_index)
# Combine dataframes 
...
ggsave(here,orig_rt,width=11,height=4)
...
p1 <- p1 + ggplot2::labs(y = "Median Rt") + ggplot2::facet_wrap(~group,scales="free_y") + scale_color_brewer(palette="Paired") + ggtitle("Effective R trajectory for Cambodia (Recipient)")
...
p2 <- p2 + ggplot2::labs(y = "Median Rt") + ggplot2::facet_wrap(~group,,scales="free_y") + scale_color_brewer(palette="Paired")  + ggtitle("Effective R trajectory for Malaysia (Recipient)")
...
p3 <- p3 + ggplot2::labs(y = "Median Rt") + ggplot2::facet_wrap(~group,,scales="free_y") + scale_color_brewer(palette="Paired")  + ggtitle("Effective R trajectory for Philippines (Recipient)")
...
p4 <- p4 + ggplot2::labs(y = "Median Rt") + ggplot2::facet_wrap(~group,,scales="free_y") + scale_color_brewer(palette="Paired")  + ggtitle("Effective R trajectory for Singapore (Recipient)")
...
p5 <- p5 + ggplot2::labs(y = "Median Rt") + ggplot2::facet_wrap(~group,,scales="free_y") + scale_color_brewer(palette="Paired")  + ggtitle("Effective R trajectory for Thailand (Recipient)")
...
p1 <- p1 + ggplot2::labs(y = "Median Rt") + ggplot2::facet_wrap(~Group,scales="free_y") + 
  ggtitle("Effective R trajectory March 15- Dec 31 2020") + theme(legend.title=element_text(size=12))+
