...
dat<-data
#save data
saveRDS(dat,"/Users///COVID-Counterfactual/Top5/2021_noSI/data_2021_top5.rds")
#saveRDS(dat,paste0("/Users///COVID-Counterfactual/Top5/2021_noSI/2021_noSI/2021_noSI/data_2021_top5_iterations",iterate,"_noSI.rds"))
#
#
...
#
#
#saveRDS(fit,paste0("/Users///COVID-Counterfactual/Top5/2021_noSI/fit_2021_top5_iterations",iterate,"_noSI.rds"))
#plot_obs(fit, type = "deaths", levels = c(50, 95))
fit=readRDS("/Users///COVID-Counterfactual/Top5/2021_noSI/fit_2021_top5_iterations200_noSI.rds")
# original fit
fit$pop_adjust <- TRUE
fit_orig <- fit
# save Rt
orig_rt = plot_rt(fit,date_breaks = "1 month")
ggsave(here("/Users///COVID-Counterfactual/Top5/2021_noSI/noSI_original-rt.pdf"),orig_rt,width=11,height=4)
...
#####################################################################
pdf(here('/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/R0_ratios.pdf'))
par(mfrow=c(3,3))
...
dev.off()
#####################################################################
pdf(here('/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/boxplotR0_top5.pdf'))
...
dev.off()
#####################################################################
pdf(here('/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/PairPlot_R0_seeds.pdf'))
par(mfrow=c(1,3))
...
#
#####################################################################
pdf(here('/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/R0_prior.pdf'))
...
#
saveRDS(df,"/Users///COVID-Counterfactual/Top5/2021_noSI/counterfactual_2021_top5_iter200_noSI.rds")
...
#############################################################################
#plots
#/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/
...
p1 <- base +
  ...
  xlim(as.Date('2021-01-01'), as.Date('2022-01-01'))
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-rt_cam_1.pdf",p1,width=9,height=6)
...
p2 <- base +
  ...
  ggplot2::geom_line(
    ...
    size = 1,color='black') + xlim(as.Date('2021-01-01'), as.Date('2022-01-01'))
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-rt_mal_1.pdf",p2,width=9,height=6)
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-rt_phi_1.pdf",p3,width=9,height=6)
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-rt_sin_1.pdf",p4,width=9,height=6)
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-rt_tha_1.pdf",p5,width=9,height=6)
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-rt_1.pdf",g_rt,width=11,height=11)
######################################################################################################################################################
# Deaths
######################################################################################################################################################
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/next5rt2020two.pdf",p1,width=13,height=8)
...
p1 <- base +
  ...
  xlim(as.Date('2021-01-01'), as.Date('2021-12-31')) +  scale_x_date(
    date_breaks = date_breaks,
    labels = scales::date_format("%b")
  )
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/death2020two.pdf",p1,width=13,height=8)
#########################
# country deaths - early 2020
#########################
p1 <- base +
  ggplot2::geom_line(
    mapping = ggplot2::aes(x = date, y = deaths_median, color = colour),
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-deaths_mal_early.pdf",p1,width=9,height=6)
#
p1 <- base +
  ggplot2::geom_line(
    mapping = ggplot2::aes(x = date, y = deaths_median, color = colour),
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-deaths_cam_early.pdf",p1,width=9,height=6)
#
p1 <- base +
  ggplot2::geom_line(
    mapping = ggplot2::aes(x = date, y = deaths_median, color = colour),
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-deaths_phi_early.pdf",p1,width=9,height=6)
#
p1 <- base +
  ggplot2::geom_line(
    mapping = ggplot2::aes(x = date, y = deaths_median, color = colour),
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-deaths_sin_early.pdf",p1,width=9,height=6)
#
p1 <- base +
  ggplot2::geom_line(
    mapping = ggplot2::aes(x = date, y = deaths_median, color = colour),
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-deaths_tha_early.pdf",p1,width=9,height=6)
#
# country deaths
#########################
p1 <- base +
  ...
  xlim(as.Date('2021-01-01'), as.Date('2022-01-01')) 
p1 <- p1 + ggplot2::labs(y = "Deaths") + ggplot2::facet_wrap(~group, scales="free_y") + scale_color_brewer(palette="Paired") + ggtitle("Malaysia")
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-deaths_mal.pdf",p1,width=9,height=6)
#
p1 <- base +
  ggplot2::geom_line(
    mapping = ggplot2::aes(x = date, y = deaths_median, color = colour),
  ...
  xlim(as.Date('2021-01-01'), as.Date('2022-01-01')) 
p1 <- p1 + ggplot2::labs(y = "Deaths") + ggplot2::facet_wrap(~group, scales="free_y") + scale_color_brewer(palette="Paired") + ggtitle("Cambodia")
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-deaths_cam.pdf",p1,width=9,height=6)
#
p1 <- base +
  ggplot2::geom_line(
    mapping = ggplot2::aes(x = date, y = deaths_median, color = colour),
  ...
  xlim(as.Date('2021-01-01'), as.Date('2022-01-01')) 
p1 <- p1 + ggplot2::labs(y = "Deaths") + ggplot2::facet_wrap(~group, scales="free_y") + scale_color_brewer(palette="Paired") + ggtitle("Philippines")
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-deaths_phi.pdf",p1,width=9,height=6)
#
p1 <- base +
  ggplot2::geom_line(
    mapping = ggplot2::aes(x = date, y = deaths_median, color = colour),
  ...
  xlim(as.Date('2021-01-01'), as.Date('2022-01-01')) 
p1 <- p1 + ggplot2::labs(y = "Deaths") + ggplot2::facet_wrap(~group, scales="free_y") + scale_color_brewer(palette="Paired") + ggtitle("Singapore")
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-deaths_sin.pdf",p1,width=9,height=6)
#
p1 <- base +
  ggplot2::geom_line(
    mapping = ggplot2::aes(x = date, y = deaths_median, color = colour),
  ...
  xlim(as.Date('2021-01-01'), as.Date('2022-01-01')) 
p1 <- p1 + ggplot2::labs(y = "Deaths") + ggplot2::facet_wrap(~group, scales="free_y") + scale_color_brewer(palette="Paired") + ggtitle("Thailand")
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-deaths_tha.pdf",p1,width=9,height=6)
#
#######################################################################################################################################################
# Infections
#######################################################################################################################################################
p1 <- base +
  ...
  xlim(as.Date('2021-01-01'), as.Date('2021-03-15'))
p1 <- p1 + 
  ggplot2::geom_bar(
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-infections_cam.pdf",p1,width=9,height=6)
#
p2 <- base +
  ggplot2::geom_line(
    mapping = ggplot2::aes(x = date, y = infections_median, color = colour),
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-infections_Mal.pdf",p2,width=9,height=6)
#
p3 <- base +
  ggplot2::geom_line(
    mapping = ggplot2::aes(x = date, y = infections_median, color = colour),
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-infections_Phil.pdf",p3,width=9,height=6)
#
p4 <- base +
  ggplot2::geom_line(
    mapping = ggplot2::aes(x = date, y = infections_median, color = colour),
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-infections_sin.pdf",p4,width=9,height=6)
#
p5 <- base +
  ggplot2::geom_line(
    mapping = ggplot2::aes(x = date, y = infections_median, color = colour),
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-infections_tha.pdf",p5,width=9,height=6)
#
margin = theme(plot.margin = unit(c(0,0,0,0), "cm"))
p1=p1+margin
p2=p2+margin
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/scenario-infections_all.pdf",g_infections,width=11,height=11)
...
ggsave("/Users///COVID-Counterfactual/Top5/2021_noSI/CF_noSI_figures/infections2020two.pdf",p1,width=13,height=8)
#
